...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(
    () => ({ apiUrl, apiToken, sort, showKrw, themeMode, afterCost, widgetRowCurrency, ready, setApiUrl, setApiToken, setSort, setShowKrw, setThemeMode, setAfterCost, setWidgetRowCurrency }),
    [apiUrl, apiToken, sort, showKrw, themeMode, afterCost, widgetRowCurrency, ready, setApiUrl, setApiToken, setSort, setShowKrw, setThemeMode, setAfterCost, setWidgetRowCurrency],
  );

...
export interface ReturnMark {
   ...
   * onLayout: 감싼 동안 틀의 자리를 함께 받을 곳 (감싼 줄은 틀 안에서 y=0 이라 줄 자리를 재는 쪽 — 잔고 이어 보기 — 이 틀의 자리를 쓴다)
   */
  wrap: (code: string, row: React.ReactElement, onLayout?: (e: LayoutChangeEvent) => void) => React.ReactElement;
}

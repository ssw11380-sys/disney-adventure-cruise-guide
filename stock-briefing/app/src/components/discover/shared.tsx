...
import { Alert, StyleSheet, Text, useWindowDimensions, View, type LayoutChangeEvent } from "react-native";
...
/**
 * 넓은 창 배치(3-42)에서 표·히트맵이 실제로 받은 폭. 부르는 쪽이 틀(View)에 onLayout 을 달아 잰다.

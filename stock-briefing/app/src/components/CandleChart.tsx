...
/** 아이콘 버튼의 보이는 크기 (3-22: 24 → 32, 칩과 같음 — 칩 크기·누르는 영역은 chart/ChipStrip). 누르는 영역은 위아래로 넓혀 44, 좌우는 버튼 간격(6)의 절반만 — 이웃 버튼과 겹치지 않게 */
const ICON = CHIP_H;
...
const styles = StyleSheet.create({
  ...
  // 칩 띠의 누르는 영역(스크롤 틀을 위아래로 넓혀 44 를 품게 하는 것)은 chart/ChipStrip 이 맡는다
  grow: { flex: 1 },

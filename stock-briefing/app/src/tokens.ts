...
export const foldScreens = {
  ...
  settingsColMin: 340,
  /**
   * 설정 카드 한 칸의 최대 폭 (글자 크기와 상관없음) — 이름과 스위치 사이가 300dp 이하 (설계 칸 폭 범위 310~430 의 위 끝).
   * 폴드8 펼침 가로·울트라 펼침 세로(칸 약 415)는 칸을 다 쓰고, 울트라 펼침 가로(약 465)는 430 으로 줄어 남는 폭은 두 칸 사이로만 (양 끝에 붙는다)
   */
  settingsColMax: 430,
  /**

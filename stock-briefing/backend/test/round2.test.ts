...
describe("EdgarProvider", () => {
  ...
  it("티커 → CIK, 10-K 연간 값만 골라 재무제표를 만든다", async () => {
    ...
    const noOp = "영업이익: 회사가 영업이익 항목을 보고하지 않아 비워 둠 (세전이익으로 대신하지 않음)";
    expect(fin).toEqual([
      { year: 2024, basis: "CFS", revenue: 97690000000, operatingIncome: null, netIncome: 7091000000, totalAssets: 122070000000, totalLiabilities: null, totalEquity: null, currency: "USD", notes: [noOp, "부채총계: 회사가 따로 보고하지 않아 비워 둠"] },

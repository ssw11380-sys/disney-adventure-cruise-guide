...
export const FEATURES = {
  ...
  widgetFoldFit: {
    default: true,
    description:
      "폴드 위젯 크기 맞추기 (위젯 2차, 앱만 — /api/widget features 로 전달): 넓은 모습(잔고 평가금액 칸·두 열, 지수·환율 구역 안 옆 칸)을 위젯 폭 560dp 이상에서만 씀(폴드8 바깥 화면 4x2 약 507~516dp 에 평가금액 칸이 나오던 것). 폭 하나로만 정하고 화면 크기·방향·위젯마다의 기억은 보지 않음. 안쪽 화면에 넓게 늘린 위젯(약 780dp)은 그대로, 달라지는 것은 폭 504~559dp 위젯뿐. 켜져 있으면 위젯 크기 진단 기록(기기 안, 설정 '화면 정보' 공유 글에만)도 적음. 끄면 예전 기준 그대로(그림이 한 글자도 같음)",
  },
  widgetRefreshLog: {
    default: true,
    description:
